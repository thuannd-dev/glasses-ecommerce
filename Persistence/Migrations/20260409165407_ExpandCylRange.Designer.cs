...
namespace Persistence.Migrations
{
    ...
    [Migration("20260409165407_ExpandCylRange")]
    partial class ExpandCylRange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.CartItem", b =>
                {
                    ...
                    b.Property<decimal>("CoatingExtraPrice")
                        .HasColumnType("decimal(10,2)");

                    b.Property<Guid?>("LensVariantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal?>("PrescriptionAddOD")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionAddOS")
                        .HasColumnType("decimal(5,2)");

                    b.Property<int?>("PrescriptionAxisOD")
                        .HasColumnType("int");

                    b.Property<int?>("PrescriptionAxisOS")
                        .HasColumnType("int");

                    b.Property<decimal?>("PrescriptionCylOD")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionCylOS")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionPd")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionPdOD")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionPdOS")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionSphOD")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("PrescriptionSphOS")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.Property<string>("SelectedCoatingIdsJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.FrameLensCompatibility", b =>
                {
                    b.Property<Guid>("FrameProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("LensProductId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FrameProductId", "LensProductId");

                    b.HasIndex("FrameProductId")
                        .HasDatabaseName("IX_FrameLensCompatibility_FrameProductId");

                    b.HasIndex("LensProductId")
                        .HasDatabaseName("IX_FrameLensCompatibility_LensProductId");

                    b.ToTable("FrameLensCompatibilities");
                });
            ...
            modelBuilder.Entity("Domain.LensCoatingOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LensProductId", "IsActive")
                        .HasDatabaseName("IX_LensCoatingOption_LensProductId_IsActive");

                    b.ToTable("LensCoatingOptions", t =>
                        {
                            t.HasCheckConstraint("CK_LensCoatingOption_ExtraPrice", "[ExtraPrice] >= 0");
                        });
                });

            modelBuilder.Entity("Domain.LensVariantAttribute", b =>
                {
                    b.Property<Guid>("ProductVariantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal?>("AddMax")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("AddMin")
                        .HasColumnType("decimal(5,2)");

                    b.Property<int>("AxisMax")
                        .HasColumnType("int");

                    b.Property<int>("AxisMin")
                        .HasColumnType("int");

                    b.Property<decimal>("CylMax")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("CylMin")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Index")
                        .HasColumnType("decimal(4,2)");

                    b.Property<int>("LensDesign")
                        .HasColumnType("int");

                    b.Property<decimal>("SphMax")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("SphMin")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.HasIndex("LensDesign")
                        .HasDatabaseName("IX_LensVariantAttribute_LensDesign");

                    b.HasIndex("SphMin", "SphMax")
                        .HasDatabaseName("IX_LensVariantAttribute_SphRange");

                    b.ToTable("LensVariantAttributes", t =>
                        {
                            t.HasCheckConstraint("CK_LensVariantAttribute_AxisRange", "[AxisMin] >= 0 AND [AxisMax] <= 180 AND [AxisMin] <= [AxisMax]");

                            t.HasCheckConstraint("CK_LensVariantAttribute_CylRange", "[CylMin] <= [CylMax]");

                            t.HasCheckConstraint("CK_LensVariantAttribute_Index", "[Index] > 0");

                            t.HasCheckConstraint("CK_LensVariantAttribute_LensDesign", "[LensDesign] IN (1, 2, 3)");

                            t.HasCheckConstraint("CK_LensVariantAttribute_SphRange", "[SphMin] <= [SphMax]");
                        });
                });
            ...
            modelBuilder.Entity("Domain.OrderItem", b =>
                {
                    ...
                    b.Property<string>("CoatingsSnapshot")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("OrderItems", t =>
                        {
                            t.HasCheckConstraint("CK_OrderItem_CoatingExtraPrice", "[CoatingExtraPrice] >= 0");

                            t.HasCheckConstraint("CK_OrderItem_LensUnitPrice", "[LensUnitPrice] >= 0");
                    ...
                    b.ToTable("PrescriptionDetails", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PrescriptionDetail_CYL", "[CYL] IS NULL OR ([CYL] BETWEEN -6.00 AND 6.00)");
            ...
            modelBuilder.Entity("Domain.CartItem", b =>
                {
                    ...
                    b.HasOne("Domain.ProductVariant", "LensVariant")
                        .WithMany()
                        .HasForeignKey("LensVariantId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.FrameLensCompatibility", b =>
                {
                    b.HasOne("Domain.Product", "FrameProduct")
                        .WithMany("CompatibleLensLinks")
                        .HasForeignKey("FrameProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Product", "LensProduct")
                        .WithMany()
                        .HasForeignKey("LensProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FrameProduct");

                    b.Navigation("LensProduct");
                });
            ...
            modelBuilder.Entity("Domain.LensVariantAttribute", b =>
                {
                    b.HasOne("Domain.ProductVariant", "Variant")
                        .WithOne("LensVariantAttribute")
                        .HasForeignKey("Domain.LensVariantAttribute", "ProductVariantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Product", b =>
                {
                    b.Navigation("CoatingOptions");

                    b.Navigation("CompatibleLensLinks");
            ...
            modelBuilder.Entity("Domain.ProductVariant", b =>
                {
                    ...
                    b.Navigation("LensVariantAttribute");
