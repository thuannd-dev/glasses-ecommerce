      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <button onClick={exportAllExcel} className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors border border-indigo-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-gradient-to-br from-white to-slate-50/30 rounded-3xl p-8 border border-slate-200/60 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            {revenue && !isLoading && (
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-5 border border-indigo-100/50 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="text-xs text-indigo-600 font-medium">
                    {revenue.totalOrders} orders • {revenue.completedOrders} completed
                  </div>
                </div>
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-5 border border-emerald-100/50 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold text-emerald-600 uppercase tracking-wider">Net Revenue</span>
            ...
            {isLoadingMonthly ? (
              ...
              <div className="w-full h-[340px] bg-slate-50 rounded-2xl flex items-center justify-center text-slate-400 border border-slate-200">
                <div className="text-center">
...
function RevenueTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-5 rounded-2xl shadow-2xl border border-slate-700/50 min-w-[200px] backdrop-blur-sm">
      <div className="flex items-center gap-2 mb-3 pb-3 border-b border-slate-700">
        <div className="w-3 h-3 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500"></div>
        <p className="text-sm font-bold text-white">{label}</p>
      </div>
      <div className="space-y-2.5">
        <div className="flex justify-between items-center gap-6">
          <span className="text-xs text-slate-400 font-medium uppercase tracking-wider">Revenue</span>
          <span className="text-base font-bold text-indigo-300">{formatCurrency(payload[0].value)}</span>
        </div>
        {payload[0].payload.orders != null && (
          <div className="flex justify-between items-center gap-6">
            <span className="text-xs text-slate-400 font-medium uppercase tracking-wider">Orders</span>
            <span className="text-base font-bold text-white">{payload[0].payload.orders}</span>
          </div>
        )}
        {payload[0].payload.discount != null && payload[0].payload.discount > 0 && (
          <div className="flex justify-between items-center gap-6">
            <span className="text-xs text-slate-400 font-medium uppercase tracking-wider">Discount</span>
