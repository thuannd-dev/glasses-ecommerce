...
import { Box, Typography, Grid, Paper, Chip, LinearProgress, IconButton, useTheme, useMediaQuery } from "@mui/material";
import { Menu as MenuIcon, People, ShoppingCart, AttachMoney, PendingActions, Inventory } from "@mui/icons-material";
