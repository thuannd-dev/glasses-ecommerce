...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    productName: "Versace Medusa",
    type: 1,
    brand: "Versace",
    description: "Luxury eyewear with iconic Medusa emblem",
    minPrice: 279.99,
    maxPrice: 449.99,
  ...
  },
  {
    ...
    productName: "CooperVision Biofinity",
    type: 2,
    brand: "CooperVision",
    description: "Premium contact lenses with aquaform technology",
    minPrice: 44.99,
    maxPrice: 64.99,
    ...
    firstImage: {
      id: "img-012",
      imageUrl: "https://images.unsplash.com/photo-1509587891217-51ac28680050?w=200&h=200&fit=crop",
      altText: "CooperVision Biofinity",
      displayOrder: 1,
      modelUrl: null,
    },
    category: {
  ...
  },
  {
    ...
    productName: "Alcon AIR OPTIX",
    type: 2,
    brand: "Alcon",
    description: "Monthly contact lenses for extended wear",
    minPrice: 34.99,
    maxPrice: 54.99,
    totalQuantityAvailable: 95,
    status: "Active",
  ...
  },
  {
    ...
    productName: "Lens Solution Bundle",
    type: 3,
    brand: "Generic",
    description: "Complete eye care solution kit with case",
    minPrice: 24.99,
    maxPrice: 39.99,
    totalQuantityAvailable: 160,
    status: "Active",
  ...
  },
  {
    ...
    productName: "Sports Performance Glasses",
    type: 1,
    brand: "Nike",
    description: "Aerodynamic design for athletic performance",
    minPrice: 159.99,
    maxPrice: 249.99,
  ...
  },
  {
    ...
    productName: "Reading Glasses Plus",
    type: 1,
    brand: "Generic",
    description: "Prescription reading glasses with anti-reflective coating",
    minPrice: 59.99,
    maxPrice: 99.99,
    totalQuantityAvailable: 73,
    status: "Active",
    createdDate: "2025-02-04",
    updatedDate: "2025-02-05",
    firstImage: {
    ...
    category: {
      ...
      description: "Eyewear for reading and close work",
    },
  },
];
